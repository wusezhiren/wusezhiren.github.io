(function (root, factory) {
  ...
  function createChargeCrash(context = {}, data = {}, timeline = {}) {
    ...
    event('body', { action: 'charge-crash', direction: dir }); event('weapon', { action: 'charge-crash' }); event('phase', { name: phases[0].name }); event('move', { distance: phases[0].move * dir, direction: dir });
